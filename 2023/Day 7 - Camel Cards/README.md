...
_"J"s now represent "Jokers" instead of "Jacks". They are wildcards with 2 properties:_

- _They transform to be whatever makes the hand the strongest when evaluating hand-types_
- _They are not transformed when comparing individual cards, and are considered the weakest card in this comparison (2 > J)_

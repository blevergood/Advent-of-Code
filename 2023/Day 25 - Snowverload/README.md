...
_You are given string inputs representing "wires" or nodes and edges in an undirected graph. You need to cut exactly 3 wires in order to create two disjointed graphs. Return the product of the respective sizes of these two graphs._

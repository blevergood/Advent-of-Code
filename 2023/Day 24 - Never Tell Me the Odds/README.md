...
_You're given lines of text each representing a vector equation in the format `x0, y0, z0 @ vx, vy, vz`._

_Ignoring the z-axis determine which pairs of vectors/lines cross paths (not whether the object at the head of the paths actually collide)._
...
Your puzzle answer was **`15558`**.

## Part Two

### Summary

_Taking the all 3 dimensions into consideration, find the starting point and velocity required to actually collide with every single projectile. Return the sum of the coordinates of the starting position._
...
Your puzzle answer was **`765636044333842`**.
